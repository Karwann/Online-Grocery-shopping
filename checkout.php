...
<html lang="en">
<head>
    <title>Customer Cart - AK Grocery</title>
    <meta charset="utf-8">
...
<h1 class="text-center text-black mb-5"
    style="font-family: 'inherit',sans-serif; margin-top: 20px;">
...
<form action="payment.php" method="post">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title bg-danger text-white p-2"> Dinnar <?php echo $items['price'];  ?></h6>
    ...
    <div class="text-center text-danger mb-3" style="padding-top: 20px;">
        ...
        <select class="selectpicker" name="delivery">
            <option value="1">Normal (+ 5000 Dinnar)</option>
            <option value="2">Express (+ 10000 Dinnar)</option>
        </select>
    </div>
    ...
    <div class="text-center text-danger mb-5">
        <button name="payment" class="btn btn-info" >Confirm & Pay Dinnar <?php echo $tot;?> + Shipping </button>
    </div>
</form>
