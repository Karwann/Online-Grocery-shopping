  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="btn btn-success" id="cout" data-dismiss="modal">Checkout</button>' +
    ...
    $('#cout').click(function () {
        var something= ProductManager.getAllProducts();
        var total= ProductManager.getTotalPrice();
        console.log(something[0]["id"]);

        var arrStr = JSON.stringify(something);

        window.location.href = "checkout.php?array="+arrStr+"&total="+total;
    }); 
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">Dinnar ' + this.price + '</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">Dinnar ' + total + '</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '"> Dinnar </strong></td>' +
        '<td></td>' +
        '</tr>'
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          ...
          '<td></td>' +
          '<td></td>' +
          '<td><strong id="' + idDiscountPrice + '"> Dinnar </strong></td>' +
          '<td></td>' +
          '</tr>'
        );
      }
    ...
    var showGrandTotal = function(){
      $("#" + idGrandTotal).text("Dinnar " + ProductManager.getTotalPrice());
    }
    var showDiscountPrice = function(){
      $("#" + idDiscountPrice).text("Dinnar " + options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity()));
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text("Dinnar " + price * quantity);
