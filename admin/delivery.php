        ...
        <table class="table table-striped table-sm">
          <thead>
            ...
            <tr>
            	...
            	<td><?php echo $res2['street']."<br>".$res2['city']; ?></td>
            </tr>
          <?php }?>
          </thead>
...
if(isset($_POST['submit']))
{
  ...
  if($name != "" && $email != "" && $street != "" && $city != "" && $phone != "")
  {
     $q2= $con->query("INSERT into delivery (id, username, email, street, city,  phone) VALUES (DEFAULT,'$name','$email','$street','$city','$phone')");
     echo "<script type='text/javascript'>window.location.href='delivery.php';</script>";
  }
  else{
